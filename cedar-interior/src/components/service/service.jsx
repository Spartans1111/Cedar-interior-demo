  ...
  return (
        ...
        <div className="servicehero1">
            <div className="servicehero1col">
                     <div className="discount">
                        <h2 className="header2"><span>Home Interior Design
                        Starting from</span> 2 Lakhs</h2>
    ...
    <div className="serviceinterior">
      <div className="serviceinteriorcol  sercol1">
        <div className="service-slide"> <Aboutslider/></div>
      </div>
...
<Awardandwinning/>
      ...
      <div className="hrline-bg"><div className="hrline"></div> </div>
<Homeservice/>
<Serviceabt/>
<Serportfolio/>
